...
export class ProyectosController {
  ...
  async exportarCsv(
    ...
    const csv = await this.proyectosExportacionesService.exportarProyectosCsv(
      nombre,
      estado,
    );
  ...
  async exportarJson(
    ...
    const json = await this.proyectosExportacionesService.exportarProyectosJson(
      nombre,
      estado,
    );
    ...
    res!.setHeader(
      'Content-Disposition',
      'attachment; filename="proyectos.json"',
    );
    res!.send(json);
  }
  ...
  async exportarExcel(
    ...
    const buffer =
      await this.proyectosExportacionesService.exportarProyectosExcel(
        nombre,
        estado,
      );
    res!.setHeader(
  ...
  async exportarPdf(
    ...
    const buffer =
      await this.proyectosExportacionesService.exportarProyectosPDF(
        nombre,
        estado,
      );
